...
const NAMESPACE_META: Record<string, NamespaceMeta> = {
  ...
  bookingHistory: { category: 'booking', page: { da: 'Bookinghistorik', en: 'Booking history' } },
  bookingExport: { category: 'booking', page: { da: 'Eksport af bookinger', en: 'Booking export' } },
  bookingExportSchedule: { category: 'booking', page: { da: 'Planlagt eksport', en: 'Scheduled export' } },
  bookingLevels: { category: 'config', page: { da: 'Kursistniveauer', en: 'Participant levels' } },
  ...
  bookingReport: { category: 'booking', page: { da: 'Bookingrapport', en: 'Booking report' } },
  bookingImport: { category: 'booking', page: { da: 'Bookingimport', en: 'Booking import' } },
  bookingRecon: { category: 'booking', page: { da: 'Afstemning', en: 'Reconciliation' } },
  bookingServices: { category: 'booking', page: { da: 'Tilkøbsydelser på booking', en: 'Add-on services on a booking' } },
  bookingServicesPage: { category: 'booking', page: { da: 'Tilkøbsydelser', en: 'Add-on services' } },
  bookingTariffs: { category: 'booking', page: { da: 'Priser og takster', en: 'Prices and rates' } },
  bookingVat: { category: 'booking', page: { da: 'Momskoder', en: 'VAT codes' } },
  ...
  companyAccounting: { category: 'config', page: { da: 'Regnskabssystem', en: 'Accounting system' } },
  economicMapping: { category: 'config', page: { da: 'Mapning til e-conomic', en: 'Mapping to e-conomic' } },
  companyAi: { category: 'config', page: { da: 'AI-opsætning', en: 'AI setup' } },
  companyDalux: { category: 'config', page: { da: 'Dalux FM', en: 'Dalux FM' } },
  companyDataTransfer: { category: 'config', page: { da: 'Dataoverførsel', en: 'Data transfer' } },
  companyExport: { category: 'config', page: { da: 'Fuldt dataudtræk', en: 'Full data export' } },
  ...
  invoiceDrafts: { category: 'booking', page: { da: 'Fakturakladder', en: 'Invoice drafts' } },
